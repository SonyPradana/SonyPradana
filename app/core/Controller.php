...
class Controller extends Middleware{
    protected $_template = BASEURL . '/app/views/StandartTempalte.php';

    public function template($tamplate_name){
        $file_location = BASEURL . '/app/views/' . $tamplate_name . '.php';
        if( !file_exists($file_location) ){
            $file_location = BASEURL . '/app/views/StandartTempalte.php';
        }
    ...
    public function view($view, $portal = []){
        ...
        // require component
        require_once BASEURL . "/app/views/" . $view . '.template.php';
        // require js & css
    ...
    public static function view_exists($view) :bool{
        return file_exists( BASEURL . "/app/views/" . $view . '.template.php');
    }

    public static function getController($contoller, $method, $args = []){
        $contoller          = ucfirst($contoller) . 'Controller';
        $contoller_location = BASEURL .'/app/controllers/' . $contoller . '.php';
