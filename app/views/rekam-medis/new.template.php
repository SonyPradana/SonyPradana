        ...
        <div class="boxs">
          ...
          <div class="box right">
            ...
            <form id="new-rm-form" class="new-rm" action="" method="post">
              ...
              <input class="textbox outline black rounded small block" type="text" name="nomor_rm_kk" id="input-nomor-rm-kk" placeholder="nomor rm kepala keluarga" value="<?= $content->nomor_rm_kk ?>" minlength="6" maxlength="6" inputmode="numeric" pattern="[0-9]*" >
