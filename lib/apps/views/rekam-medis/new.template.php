                ...
                <div class="box right">
                    <h1>Data Rekam Medis Baru</h1>
                        <form class="new-rm" action="" method="post">
                            <input class="textbox outline black rounded small block" type="number" name="nomor_rm" id="input-nomor-rm" placeholder="nomor rekam medis" value="<?= $content->nomor_rm ?>" maxlength="6" inputmode="numeric" pattern="[0-9]*">
