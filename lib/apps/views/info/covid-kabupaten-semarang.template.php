...
<head>
    ...
    <link rel="stylesheet" href="/css/style.css?ver=1.0&ref=covid&mix=style;cards;widgets">
    <script src="/js/app.js?mix=index.min;bundles/keepalive.min;vendor/vue/vue.min;vendor/chart/Chart.min;vendor/enquire/enquire.min"></script>
    <style>
