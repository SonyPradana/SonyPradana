...
class CLI
{
  ...
  private const MAKE_CONTROLLER = array (
    'template_location' => '/lib/apps/core/template/controller',
    'save_location' => '/lib/apps/controllers/',
    'pattern' => '__controller__',
    'surfix' => 'Controller.php'
  );
  private const MAKE_VIEW = array (
    'template_location' => '/lib/apps/core/template/view',
    'save_location' => '/lib/apps/views/',
    'pattern' => '__view__',
    'surfix' => '.template.php'
  );
  private const MAKE_SERVICE = array (
    'template_location' => '/lib/apps/core/template/service',
    'save_location' => '/lib/apps/services/',
    'pattern' => '__service__',
    'surfix' => 'Service.php'
  );
  private const MAKE_MODEL = array (
    'template_location' => '/lib/apps/core/template/model',
    'save_location' => '/lib/apps/library/Model/',
    'pattern' => '__model__',
    'surfix' => '.php'
  );
      ...
      switch ($param[1]) {
        ...
        case 'model':
          ...
          if (substr($option[1], 0, 12) == '--table-name') {
            ...
            $this->FillModelDatabase($this->BASE_DIR . '/lib/apps/library/Model/' . $option[0] . '/' . $option[0] . '.php', $table_name);
          }
          break;
